...
function addChapterRecord($chapterID, $currentBookID, $chapterNumber)
{
	...
	if (testamentName == "Old")
		...
		$testamentID = 2;
	//$sql = "INSERT INTO  'davean8_Bible'.'AsvChapters' ('ID','BookID', 'ChapterNumber', 'Notes') VALUES ('$chapterID',  '$currentBookID',  '$chapterNumber', '')";
...
{
	//$sql ="INSERT INTO  'davean8_Bible'.'AsvVerses' ('ID', 'ChapterID', 'VerseNumber', 'Verse', 'Notes') VALUES ('$verseID',  '$chapterID',  '$verseNumber', '$verse', '')";
...
VALUES (
'2',  'ASV',  'American Standard Version',  'American Standard Version'
);
*/
