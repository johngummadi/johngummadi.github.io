...
$xmlFile = "Output/web-combined.xml";
...

{
	...
	$sql = "INSERT INTO  WebBooks VALUES ('$bookID',$translationID,'$bookFullName','','$testamentID','')";
...

{
	...
	$sql = "INSERT INTO WebChapters VALUES ('$chapterID','$currentBookID','$chapterNumber','')";
...

{
	...
	$sql ="INSERT INTO WebVerses VALUES('$verseID','$chapterID','$verseNumber','$verse','')";
