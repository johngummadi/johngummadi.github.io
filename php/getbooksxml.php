...
function getBooks()
{
	...
	while ($index < $rowCount) 
	{
		...
		// Echo each book
		$bookLine = "	<book BookID=\"$bookID\" FullName=\"$fullName\" ShortName=\"$shortName\" ChapterCount=\"$chapterCount\" CommentCount=\"$commentCount\"> $fullName </book>\r\n";
		echo $bookLine;
		$index++;
	}
	// End of book xml
